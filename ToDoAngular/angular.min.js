...
function $RouteProvider(){
   ...
   *    Object properties:
   *
   *    - `controller` вЂ“ `{function()=}` вЂ“ Controller fn that should be associated with newly
   *      created scope.
   *    - `template` вЂ“ `{string=}` вЂ“ path to an html template that should be used by
 ...
 * * Controller вЂ” The `ng-controller` directive specifies a Controller class; the class has
 ...
 *   * `$position` вЂ“ `{string}` вЂ“ position of the repeated element in the iterator. One of:
 *        * `'first'`,
 *        * `'middle'`
 *        * `'last'`
 *
